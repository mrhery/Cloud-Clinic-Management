			...
			<div class="row">
				<div class="col-md-6 mb-3">
					<div class="row">
						<div class="col-md-6">
							Date:
							<input type="date" class="form-control" name="doc_date" value="<?= date("Y-m-d", strtotime($t->t_doc_datetime)) ?>" required /><br />
						...
						<div class="col-md-6">
							Time:
							<input type="time" class="form-control" name="doc_time" value="<?= date("H:i", strtotime($t->t_doc_datetime)) ?>" /><br />
							
							No:
							<input type="text" class="form-control" name="doc_no" placeholder="Doc. No" value="<?= $t->t_doc_no ?>" /><br />
						</div>
					</div>
					
					Amount (RM):
					<input type="number" step="0.01" class="form-control" name="amount" placeholder="0.00"  value="<?= $t->t_amount ?>" required /><br />
							
					Desription:
					<textarea class="form-control" placeholder="Description" name="description"><?= $t->t_description ?></textarea>
				</div>
				...
				<div class="col-md-6 mb-3">
					<div class="card border-info">
						...
						<div class="card-body">							
							Class:
							<select class="form-control" name="account_class">
