...
<div class="card">
    <div class="card-header">
        <span class="fa fa-building"></span> Sales Records
		
		<a href="<?= PORTAL ?>billing/sales/add" class="btn btn-primary btn-sm">
        ...
        <table class="table dataTable table-hover table-fluid">
			...
			<?php
				...
				<tr>
					...
					<td class="text-right">
						<a href="<?= PORTAL ?>billing/sales/view/<?= $s->s_key ?>" class="btn btn-sm btn-info">
