...
<div class="card">
	...
	<div class="card-body">
		<div class="row">				
			<div class="col-md-6">
				Name:
				<input type="text" class="form-control" id="name" placeholder="Item name" /><br />
			...
			<div class="col-md-6">					
				Code:
				<input type="text" class="form-control" id="code" placeholder="Item code" /><br />
				
				SKU:
				<input type="text" class="form-control" id="sku" placeholder="SKU(s)" /><br />
			</div>
				...
				<table class="table table-hover table-fluid table-bordered">
					...
					<tfoot>
						<tr>
							...
							<td>
								<input type="number" id="total" class="form-control text-right" value="0.00" step="0.01" placeholder="0.00" />
							</td>
						</tr>
					</tfoot>
				</table>
...
$("#save").on("click", function(){
	...
	$.ajax({
		url: PORTAL + "webservice/items/create-package",
		method: "POST",
		data: {
